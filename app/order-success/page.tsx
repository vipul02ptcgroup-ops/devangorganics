      ...
      <div style={{ maxWidth: "600px", width: "100%", textAlign: "center" }}>
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "linear-gradient(135deg, rgba(201,168,76,0.15), rgba(201,168,76,0.3))",
        ...
        >
          Thank you for choosing Devang Organics
        </p>
        <p
          style={{
            color: "#C8C0B0",
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <p style={{ color: "#F5F0E8", fontFamily: "Cinzel, serif" }}>
                3-5 business days
              </p>
            </div>
          </div>
          ...
          >
            <div
              style={{
                ...
                right: "10%",
                height: "2px",
                background: "linear-gradient(90deg, #C9A84C 40%, #2A2A2A 40%)",
              }}
            />
            {[
