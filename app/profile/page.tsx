    ...
    <ProtectedRoute>
      ...
      <aside>
        ...
        <div style={{ background: "#161616", border: "1px solid #2A2A2A", padding: "1.5rem", marginBottom: "1rem", textAlign: "center" }}>
          ...
          <h3 style={{ fontFamily: "Cinzel, serif", color: "#F5F0E8", marginBottom: "4px" }}>{displayName}</h3>
        ...
        <div style={{ background: "#161616", border: "1px solid #2A2A2A" }}>
          ...
          <button onClick={handleSignOut} style={{ display: "flex", alignItems: "center", gap: "12px", width: "100%", padding: "14px 20px", background: "none", border: "none", borderTop: "1px solid #2A2A2A", cursor: "pointer", color: "#666", fontFamily: "Raleway, sans-serif", fontSize: "0.875rem" }}>
