        ...
        >
          <div>
            ...
            <div style={{ marginTop: "1.5rem", display: "flex", gap: "1rem" }}>
              <div style={{ flex: 1, position: "relative" }}>
                ...
                />
                <input
                  placeholder="Coupon code (DEVANG20)"
                  style={{
                    width: "100%",
          ...
          >
            ...
            {[
              ...
              >
                <span style={{ color: "#C8C0B0", fontSize: "0.875rem" }}>{label}</span>
                <span
                  style={{
                    color:
                      label === "Shipping" && shipping === 0 ? "#4CAF50" : "#C9A84C",
                    fontFamily: "Cinzel, serif",
                  }}
                >
                  {value}
            ...
            {shipping > 0 ? (
              <p style={{ color: "#4CAF50", fontSize: "0.75rem", marginBottom: "1rem" }}>
                Add Rs{499 - cartTotal} more for free shipping!
              </p>
            ) : null}
            <Link
              href="/checkout"
              style={{
                ...
                gap: "8px",
                background:
                  "linear-gradient(135deg, #C9A84C 0%, #E8C96A 50%, #9A7A2E 100%)",
                padding: "14px",
                color: "#0A0A0A",
                fontFamily: "Cinzel, serif",
                fontWeight: 700,
